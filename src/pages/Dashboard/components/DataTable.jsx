      ...
      <div className="tab-content">
        <table className="w-full table-auto text-sm text-left">
          <thead className=" bg-[#F9F9F9] px-3">
            <tr>
              <th className="p-4">
                <h6 className="font-semibold text-sm text-[#020202]">Apartment</h6>
              </th>
              <th className="p-4">
                <h6 className="font-semibold text-sm text-[#020202]">Date</h6>
              </th>
              <th className="p-4">
                <h6 className="font-semibold text-sm text-[#020202]">Amount Paid</h6>
              </th>
              <th className="p-4">
                <h6 className="font-semibold text-sm text-[#020202]">7% Commission</h6>
              </th>
              <th className="p-4">
                <h6 className="font-semibold text-sm text-[#020202]">Payment Due</h6>
              </th>
              <th className="p-4">
